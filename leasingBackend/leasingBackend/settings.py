...
DEBUG = True
ALLOWED_HOSTS = ["nlcontract.ru", "localhost", "127.0.0.1", "85.193.81.210", "90.156.208.15"]
CSRF_TRUSTED_ORIGINS = ['https://nlcontract.ru', 'http://localhost:8000', 'http://85.193.81.210:8000', 'http://90.156.208.15:8000']
